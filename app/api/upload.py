...
@router.post(
    ...
    summary="Upload and process a PDF or image",
    description=(
        "Accepts a PDF or image file, stores it, and starts background processing.\n"
        "Categorization runs automatically; duplicates are detected and handled."
    ),
    responses={
        400: {"model": ErrorResponse, "description": "Validation / unsupported media type"},
